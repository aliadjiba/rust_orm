...
//     parent_id: &str,
// ) -> Result<Self, ErrorIO> {
//     // Step 1: get related IDs from pivot table
//     let related_ids: Vec<String> = Query::<Pivot>::new(repo)
//         .from_table(pivot_table)
//         .select(vec![related_key])
//         .where_eq(foreign_key, parent_id)
//         .all_as::<String>()
//         .await?;
...
If you want to level this up from “good ORM” → “professional ORM”, next steps:

Split builders (Select, Insert, Update, Delete)

Introduce typed expressions (no raw strings)

Optional: macro for fields

Add RETURNING abstraction

Add transaction support

If you want, I can:

Refactor this into a clean multi-builder architecture

Or help you turn this into a crate-quality ORM
